...
swagger_template = {
    "info": {
        "title":       "Consumer Complaint Classifier — Logistic Regression",
        "description": "Pipeline: Raw text → Preprocess (Lemmatization) → TF-IDF → Predict → Yes / No",
        "version":     "1.0.0",
    },
...
def _predict_single(raw_text: str) -> dict:
    ...
    probability  = float(model.predict_proba(tfidf_vec)[0])
    return {
      ...
      200:
        ...
        schema:
          ...
          properties:
            ...
            model:
              type: string
              example: LogisticRegressionCustom
            classes:
              type: array
              items:
                type: string
      ...
      200:
        ...
        schema:
          ...
          properties:
            ...
            clean_text:
              type: string
              example: "contact bank multiple time receive response"
            latency_ms:
              type: number
              example: 12.5
      400:
